...
TrialsToLoad=[3 8 9 10];
Hz = {'IC PRE','50 Hz', '80Hz','100Hz'};

% TrialsToLoad=[3 175 181 180 182];
...
% pathName = 'P:\projects\monkeys\Proprioception\ANIMALS\Mk-Opal M63-18\20211208 - Experiments\DATA\mat\';
...
%Hz = {'IC alone POST', '50 Hz', '80Hz','100Hz'};
...
%% PANEL B: COMBINED PERCENT INCREASE JK
%close all
